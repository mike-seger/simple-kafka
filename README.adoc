...
This demonstrates a Kafka Producer and Consumer within a single
...
|===
|Action |URL
|Seek back 10 minutes |GET: {http://localhost:8080/api/seek-back/PT10M}
|Seek back to the beginning |GET: {http://localhost:8080/api/seek-to-beginning}
|Seek back to the end |GET: {http://localhost:8080/api/seek-to-end}
|===

==== Show a JSON message as an AVRO hexdump

Using: link:https://httpie.io/
