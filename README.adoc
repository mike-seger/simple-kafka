...
|===
|Action |URL
|Seek back 10 minutes |GET: link:http://localhost:8080/api/seek-back/PT10M
|Seek back to the beginning |GET: link:http://localhost:8080/api/seek-to-beginning
|Seek back to the end |GET: link:http://localhost:8080/api/seek-to-end
|===
