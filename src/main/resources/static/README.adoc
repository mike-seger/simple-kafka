...
|Seek back to the beginning |GET:
link:link:http://localhost:8080/api/seek-to-beginning
...
....
http --json POST link:http://localhost:8080/api/schema/user1/to-avro-hex/ name=Joe2 age:=8000
....
